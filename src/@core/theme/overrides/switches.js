      ...
      styleOverrides: {
        root: ({ theme }) => ({
          ...
          '& .MuiSwitch-track': {
            ...
            border: `1px solid rgba(${extractRGB(theme.palette.customColors.main)}, ${theme.palette.mode === 'dark' ? 0.4 : 0.2})`,
            transition:
        ...
        switchBase: ({ theme }) => ({
          ...
          color: `rgba(${extractRGB(theme.palette.customColors.main)}, ${theme.palette.mode === 'dark' ? 0.4 : 0.2})`,
          '&:hover': {
            backgroundColor: 'transparent !important'
          },
          '&.Mui-disabled': {
            color: `rgba(${extractRGB(theme.palette.customColors.main)}, ${theme.palette.mode === 'dark' ? 0.8 : 0.4})`,
            '& + .MuiSwitch-track': {
              borderColor: 'transparent !important',
              backgroundColor: `rgba(${extractRGB(theme.palette.customColors.main)}, ${theme.palette.mode === 'dark' ? 0.4 : 0.2})`
            },
            '&, & + .MuiSwitch-track': {
              opacity: 0.5
            },
